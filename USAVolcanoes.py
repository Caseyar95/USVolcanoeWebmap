...
def color_producer(elevation): #setting color of markers based on elevation
    if elevation < 1000:
        return "green"
...
for lt, ln, nm, ev in zip(lat, lon, name, elev): #creating markers for volcanoes
...
#creating color filter for populations
